...
var colorme = {
      ...
      $(".color_icon").click(function(){
		...
		$("#user_wrap_right").click(function(){
			...
			if (colorme.imagesize == 36) {
				...
				colorme.bpos = Math.ceil(colorme.rpos / iconswide) - 1;
				//console.log("Rows are "+colorme.bpos);
				//console.log("Right at " + colorme.tpos + " of " + colorme.bpos);
				if (colorme.bpos == 1) {
					$("#user_wrap_left img").attr("src","/images/alt1/chat_left_off.png");
					$("#user_wrap_right img").attr("src","/images/alt1/chat_right_off.png");
				}
				if (colorme.tpos >= colorme.bpos - 1) {
					return;
				}
				...
				$("#theater_icons").animate({
			  	...
			  	colorme.tpos++;
			  	//console.log("set tpos to "+colorme.tpos)
			  	if (colorme.tpos >= colorme.bpos - 1) {
						$("#user_wrap_right img").attr("src","/images/alt1/chat_right_off.png");
					}
			  });
			} else {
				if (colorme.lpos == colorme.rpos - 1) {
					return;
				}
				$("#user_wrap_left img").attr("src","/images/alt1/chat_left.png");
	...
	resize: function() {
  	...
  	if (colorme.imagesize == 36) {
			...
			//Make the width of the display area 1/2 of total icons times icon wrapper
			var width = colorme.rpos / 2 * colorme.imagesize;
  ...
  tallBox: function() {
  	...
  	$("#theater_icons").css("left","0px");
		colorme.imagesize = 36;
		colorme.scrollsize = 42;
		colorme.lpos = 0;
	...
	shortBox: function() {
  	...
  	$(".userblock").css("height","62px");
  	$("#theater_icons").css("top","0px");
  	$("#theater_icons").css("left","0px");
		colorme.imagesize = 50;
		colorme.scrollsize = 64;
		colorme.tpos = 0;
