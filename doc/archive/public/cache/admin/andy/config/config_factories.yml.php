...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/var/www/html/sites/dev.constellation.tv/public/log/admin_andy.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/var/www/html/sites/dev.constellation.tv/public/cache/admin/andy/i18n',
  'lifetime' => 31556926,
  'prefix' => '/var/www/html/sites/dev.constellation.tv/public/apps/admin/i18n',
));
...
'database' => $this->getDatabaseManager()->getDatabase('constellation_mongo'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/www/html/sites/dev.constellation.tv/public/cache/admin/andy/template',
  'lifetime' => 86400,
  'prefix' => '/var/www/html/sites/dev.constellation.tv/public/apps/admin/template',
)));
