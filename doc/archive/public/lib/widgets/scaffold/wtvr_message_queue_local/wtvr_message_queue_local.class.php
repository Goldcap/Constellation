<?php
  ...
  //require_once 'crud/wtvr_message_queue_local_crud.php';
  
   class wtvr_message_queue_local_PageWidget extends Widget_PageWidget {
  ...
  var $XMLForm;
    ...
    $this -> crud = new WtvrMessageQueueLocalCrud( $context );
