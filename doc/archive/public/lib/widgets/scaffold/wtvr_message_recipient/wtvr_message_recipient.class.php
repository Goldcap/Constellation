<?php
  ...
  //require_once 'crud/wtvr_message_recipient_crud.php';
  
   class wtvr_message_recipient_PageWidget extends Widget_PageWidget {
  ...
  var $XMLForm;
    ...
    $this -> crud = new WtvrMessageRecipientCrud( $context );
