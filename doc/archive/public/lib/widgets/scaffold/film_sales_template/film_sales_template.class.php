<?php
  ...
  //require_once 'crud/film_sales_template_crud.php';
  
   class film_sales_template_PageWidget extends Widget_PageWidget {
  ...
  var $XMLForm;
    ...
    $this -> crud = new FilmSalesTemplateCrud( $context );
