<?php
  ...
  //require_once 'crud/wtvr_message_queue_global_crud.php';
  
   class wtvr_message_queue_global_PageWidget extends Widget_PageWidget {
  ...
  var $XMLForm;
    ...
    $this -> crud = new WtvrMessageQueueGlobalCrud( $context );
