<?php
  ...
  //require_once 'crud/wtvr_message_address_crud.php';
  
   class wtvr_message_address_PageWidget extends Widget_PageWidget {
  ...
  var $XMLForm;
    ...
    $this -> crud = new WtvrMessageAddressCrud( $context );
