<?php
  ...
  //require_once 'crud/selenium_test_result_crud.php';
  
   class selenium_test_result_PageWidget extends Widget_PageWidget {
  ...
  var $XMLForm;
    ...
    $this -> crud = new SeleniumTestResultCrud( $context );
