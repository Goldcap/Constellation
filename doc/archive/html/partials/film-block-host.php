<div class="movie_block movie_block_host"> 
        ...
        <div class="movie_block_details"> 
            <h6 class="movie_block_title">Exclusive Constellation Event: JIG</h6>
          	...
          	<div class="user_images"> 
                ...
                <a href="/theater/id32Gp" title="id32Gp" class="button button_green uppercase">Hosting!</a> 
            </div>
            <div class="clearfix">
                <ul class="movie_block_details_edit uppercase">
                    <li><a href="">Delete</a></li>
                    <li><a href="">Edit Showtime</a></li>
                </ul>
            </div>
        </div>
    </div>
