...
package com.constellation.externalConfig
{
	...
	public class ExternalConfig
	{
			...
			private static const HDN_MULTI_BITRATE_VOD:String = "http://mediapm.edgesuite.net/edgeflash/public/debug/assets/smil/buckbunny-vod.smil";
			...
			private static const LOCAL_SMIL_PATH:String = "testRTMP.smil" //
			private static const LOCAL_ELE_PATH:String = "http://mediapm.edgesuite.net/ovp/content/demo/smil/elephants_dream.smil";
			...
			private var _mediaIngestType:String = "";
			private var _mediaDirectJSON:String = '{"fileURL":"http:\/\/conencrypzeri-f.akamaihd.net\/z\/movies\/77\/movie-,min,small,medium,large,.mp4.csmil\/manifest.f4m"}';
			
				//"http://mediapm.edgesuite.net/edgeflash/public/debug/assets/smil/buckbunny-vod.smil"//"../data/elephants_dream.smil";

			public var smilTestPath:String= AKAMAI_SECURE_TEST//"http://conencrypzeri-f.akamaihd.net/z/movies/56/movie-,low,small,medium,large,.mov.csmil/manifest.f4m";//"http://conencrypzeri-f.akamaihd.net/z/movies/56/movie-,low,small,medium,large,.mov.csmil/manifest.f4m";//"rtmp://cp67126.edgefcs.net/ondemand/mediapm/strobe/content/test/SpaceAloneHD_sounas_640_500_short";// "http://mediapm.edgesuite.net/edgeflash/public/debug/assets/smil/hdworld.smil"
			...
			public var REPORT_BW_TIMER_INTERVAL:Number = 5000;
			...
			private var _initialConnectionTimeDuration:Number = 60;
			private var _zeroFPSLimit:int = 30;
			private var _videoDataType:String;
			private var _zeroFPSCount:int;
			private var _mediaPlayerSprite:MediaPlayerSprite;
			private var _videoView:videoView;
			private var _logTimerInterval:Number = 60000;
			private var _logLevel:int =1;
			private var _showTimeDebugInterval:int = 10;
			private var _reportBandwidth:Boolean = true;
			private var _bufferStartMin:int = 10;
			private var _bufferMinMonitor:int;
			private var _playMonitorInterval:Number =200;
				...
				for (keyStr in paramObj)
				{
					...
					switch (keyStr)
					{
						...
						case "mediaIngestType":
							...
							break;
						case "logServicePath":
							this._logServicePath = valueStr;
							break;
						case "mediaDirectJSON":
							this._mediaDirectJSON = valueStr;
							break;
						case "initialConnectionTimeDuration":
							this._initialConnectionTimeDuration = int(valueStr);
							break;
						case "bufferStartMin":
							_bufferStartMin = int(valueStr);
							break;
						case "bufferMinMonitor":
							_bufferMinMonitor = int(valueStr);
							break;
						case "zeroFPSLimit":
							this._zeroFPSLimit = int(valueStr);
							break;
						case "reportBandwidthTimerInterval":
							_bufferStartMin = int(valueStr);
							break;
						case "playMonitorInterval":
							_playMonitorInterval = int(valueStr);
							break;
						case "reportBandwidthTimer":
							
							if(valueStr=="true"){
								this._reportBandwidth  = true;
							}else{
								this._reportBandwidth  = false;
			...
			public function get initialConnectionTimeDuration():Number
			{
				return _initialConnectionTimeDuration;
			}

			public function get zeroFPSLimit():int
			{
				return _zeroFPSLimit;
			}

			public function get videoDataType():String
			{
				return _videoDataType;
			}

			public function set videoDataType(value:String):void
			{
				_videoDataType = value;
			}

			public function get zeroFPSCount():int
			{
				return _zeroFPSCount;
			}

			public function set zeroFPSCount(value:int):void
			{
				_zeroFPSCount = value;
			}
			...
			public function set mediaPlayerSprite(value:MediaPlayerSprite):void
			{
				_mediaPlayerSprite = value;
			}
 
			public function get videoViewObject():videoView
			{
				return _videoView;
			}
			...
			public function get logTimerInterval():Number
			{
				return _logTimerInterval;
			}
			...
			public function get reportBandwidth():Boolean
			{
				return _reportBandwidth;
			}

			public function get bufferStartMin():int
			{
				return _bufferStartMin;
			}

			public function get bufferMinMonitor():int
			{
				return _bufferMinMonitor;
			}

			public function get playMonitorInterval():Number
			{
				return _playMonitorInterval;
			}
