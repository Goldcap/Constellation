package com.constellation.services
{
	...
	public class tokenService extends EventDispatcher
	{
		...
		public function parseJSON(rawJSON:Object = null):void{
			...
			/*
			Mon Oct 24 2011 12:11:41 PM [ERROR] [com.akamai.net.f4f.ZHTTPStreamingF4FFileHandler] _bytesNeeded: 1010792549
			Mon Oct 24 2011 12:11:41 PM [ERROR] [com.akamai.net.f4f.ZHTTPStreamingF4FFileHandler] ******* bytesNeeded bigger than expected potentially because fragment format is wrong!
			Mon Oct 24 2011 12:11:41 PM [INFO] [org.osmf.net.NetStreamLoadTrait] NetStream.Pause.Notify
			Mon Oct 24 2011 12:11:41 PM [INFO] [org.osmf.net.NetStreamLoadTrait] NetStream.Play.FileStructureInvalid
			!!!!! OSMF Media Error : Error: File has invalid structure
			OSMF ERROR : error ID=17 message=File has invalid structure
			MEDIA ERROR OSMF ERROR : error ID=17 message=File has invalid structure
			...
			*/
			...
			tracer.log("rawString "+rawString+"  filePath  "+filePath,_classname);
