package com.constellation.view
{
	...
	public class CircleSlicePreloader extends CasaSprite
	{
		private var timer:Timer;
		private var slices:int;
		private var radius:int;
		private var _classname:String = "com.constellation.view.CircleSlicePreloader";
		...
		{
			tracer.log("draw circles ",_classname);
		...
		private function getSlice():Shape
		{
			...
			slice.graphics.beginFill(ExternalConfig.getInstance().preloaderColor);
