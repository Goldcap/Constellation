package com.constellation.view
{
	...
	public class viewerCameraView extends Sprite 
	{
		...
		private function init(evt:Event = null):void{
			...
			//_hostcam_cpCode 			= (flashvars.cpCode == undefined) ? "113557" : flashvars.cpCode;
			hostName = "cp" + ((flashvars.hostName == undefined) ? "113557" : flashvars.hostName) + ".live.edgefcs.net/live";

			//_hostcam_streamName 		= (flashvars.streamName == undefined) ? "none" : flashvars.streamName;
			aStreamName = (flashvars.streamName == undefined) ? "constellation" : flashvars.streamName;
			
			var streamID:String = (flashvars.streamID == undefined) ? "45907" : flashvars.streamID;
			streamName = aStreamName + "@" + streamID;	
			
			//_hostcam_streamID 		= (flashvars.streamID == undefined) ? "45907" : flashvars.streamID;
			
		//	this._protocol = "rtmp://";
			
			var auth:String = (flashvars.auth == undefined ) ? "noauth" :  flashvars.auth;
			//var auth:String = (flashParams.auth == undefined ) ? "da.cXcudAc6cCbYaKcoasc6aadNbna9bVb_-bomfRT-vga-LpBF4CFqzvn-qIoYs4sFkgtDnflaqbn2trkyqUs1sD" :  flashParams.auth;
