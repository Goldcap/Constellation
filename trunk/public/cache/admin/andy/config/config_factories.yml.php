...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/home/amadsen/html/sites/dev.constellation.tv/branches/prod/public/log/admin_andy.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/home/amadsen/html/sites/dev.constellation.tv/branches/prod/public/cache/admin/andy/i18n',
  'lifetime' => 31556926,
  'prefix' => '/home/amadsen/html/sites/dev.constellation.tv/branches/prod/public/apps/admin/i18n',
));
...
if ($parameters = $this->factories['routing']->parse($this->factories['request']->getPathInfo()))
{
  ...
  $class = sfConfig::get('sf_factory_storage', 'MongoSessionStorage');
  $this->factories['storage'] = new $class(array_merge(array(
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('constellation_admin'),
'database' => $this->getDatabaseManager()->getDatabase('constellation_mongo'),
), sfConfig::get('sf_factory_storage_parameters', array (
  'session_name' => 'constellation_admin',
  'session_cookie_domain' => '.constellation.tv',
  'db_table' => 'session',
  'db_id_col' => 'session_uuid',
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/home/amadsen/html/sites/dev.constellation.tv/branches/prod/public/cache/admin/andy/template',
  'lifetime' => 86400,
  'prefix' => '/home/amadsen/html/sites/dev.constellation.tv/branches/prod/public/apps/admin/template',
)));
