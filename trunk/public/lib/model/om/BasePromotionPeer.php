...
abstract class BasePromotionPeer {
	...
	/** the column name for the PROMOTION_HTML field */
	const PROMOTION_HTML = 'promotion.PROMOTION_HTML';

	/** the column name for the PROMOTION_START_DATE field */
	const PROMOTION_START_DATE = 'promotion.PROMOTION_START_DATE';

	/** the column name for the PROMOTION_END_DATE field */
	const PROMOTION_END_DATE = 'promotion.PROMOTION_END_DATE';

	/** the column name for the PROMOTION_DURATION field */
	const PROMOTION_DURATION = 'promotion.PROMOTION_DURATION';

	/** the column name for the PROMOTION_PRIORITY field */
	const PROMOTION_PRIORITY = 'promotion.PROMOTION_PRIORITY';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('PromotionId', 'PromotionName', 'PromotionHtml', 'PromotionStartDate', 'PromotionEndDate', 'PromotionDuration', 'PromotionPriority', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('promotionId', 'promotionName', 'promotionHtml', 'promotionStartDate', 'promotionEndDate', 'promotionDuration', 'promotionPriority', ),
		BasePeer::TYPE_COLNAME => array (self::PROMOTION_ID, self::PROMOTION_NAME, self::PROMOTION_HTML, self::PROMOTION_START_DATE, self::PROMOTION_END_DATE, self::PROMOTION_DURATION, self::PROMOTION_PRIORITY, ),
		BasePeer::TYPE_FIELDNAME => array ('promotion_id', 'promotion_name', 'promotion_html', 'promotion_start_date', 'promotion_end_date', 'promotion_duration', 'promotion_priority', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('PromotionId' => 0, 'PromotionName' => 1, 'PromotionHtml' => 2, 'PromotionStartDate' => 3, 'PromotionEndDate' => 4, 'PromotionDuration' => 5, 'PromotionPriority' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('promotionId' => 0, 'promotionName' => 1, 'promotionHtml' => 2, 'promotionStartDate' => 3, 'promotionEndDate' => 4, 'promotionDuration' => 5, 'promotionPriority' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::PROMOTION_ID => 0, self::PROMOTION_NAME => 1, self::PROMOTION_HTML => 2, self::PROMOTION_START_DATE => 3, self::PROMOTION_END_DATE => 4, self::PROMOTION_DURATION => 5, self::PROMOTION_PRIORITY => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('promotion_id' => 0, 'promotion_name' => 1, 'promotion_html' => 2, 'promotion_start_date' => 3, 'promotion_end_date' => 4, 'promotion_duration' => 5, 'promotion_priority' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	{
		$criteria->addSelectColumn(PromotionPeer::PROMOTION_ID);
		$criteria->addSelectColumn(PromotionPeer::PROMOTION_NAME);
		$criteria->addSelectColumn(PromotionPeer::PROMOTION_HTML);
		$criteria->addSelectColumn(PromotionPeer::PROMOTION_START_DATE);
		$criteria->addSelectColumn(PromotionPeer::PROMOTION_END_DATE);
		$criteria->addSelectColumn(PromotionPeer::PROMOTION_DURATION);
		$criteria->addSelectColumn(PromotionPeer::PROMOTION_PRIORITY);
	}
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Promotion) {
				$key = (string) $value->getPromotionId();
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePromotionPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BasePromotionPeer', $values, $con))
      {
		...
		if ($criteria->containsKey(PromotionPeer::PROMOTION_ID) && $criteria->keyContainsValue(PromotionPeer::PROMOTION_ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.PromotionPeer::PROMOTION_ID.')');
		}
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePromotionPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BasePromotionPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePromotionPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BasePromotionPeer', $values, $con))
      {
        return $sf_hook_retval;
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(PromotionPeer::PROMOTION_ID);
			$selectCriteria->add(PromotionPeer::PROMOTION_ID, $criteria->remove(PromotionPeer::PROMOTION_ID), $comparison);
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePromotionPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BasePromotionPeer', $values, $con, $ret);
    }
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(PromotionPeer::TABLE_NAME, $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(PromotionPeer::PROMOTION_ID, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(PromotionPeer::PROMOTION_ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(PromotionPeer::DATABASE_NAME);
			$criteria->add(PromotionPeer::PROMOTION_ID, $pks, Criteria::IN);
