...
abstract class BaseGenre extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the genre_name field.
	 * @var        string
	 */
	protected $genre_name;

	/**
	 * The value for the genre_description field.
	 * @var        string
	 */
	protected $genre_description;
	...
	/**
	 * Get the [genre_name] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Get the [genre_description] column value.
	 * 
	 * @return     string
	 */
	...
	public function setGenreId($v)
	{
		...
		if ($this->genre_id !== $v) {
			$this->genre_id = $v;
			$this->modifiedColumns[] = GenrePeer::GENRE_ID;
		}
	...
	/**
	 * Set the value of [genre_name] column.
	 * 
	 * @param      string $v new value
	 * @return     Genre The current object (for fluent API support)
	 */
	public function setGenreName($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->genre_name !== $v) {
			$this->genre_name = $v;
			$this->modifiedColumns[] = GenrePeer::GENRE_NAME;
		}
	...
	/**
	 * Set the value of [genre_description] column.
	 * 
	 * @param      string $v new value
	 * @return     Genre The current object (for fluent API support)
	 */
	public function setGenreDescription($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->genre_description !== $v) {
			$this->genre_description = $v;
			$this->modifiedColumns[] = GenrePeer::GENRE_DESCRIPTION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->genre_name = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->genre_description = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->resetModified();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$this->setGenreId($pk);  //[IMV] update autoincrement primary key
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 1:
				...
				break;
			case 2:
				return $this->getGenreDescription();
				break;
			default:
				return null;
				break;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[1] => $this->getGenreName(),
			$keys[2] => $this->getGenreDescription(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 1:
				...
				break;
			case 2:
				$this->setGenreDescription($value);
				break;
		} // switch()
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setGenreName($arr[$keys[1]]);
		if (array_key_exists($keys[2], $arr)) $this->setGenreDescription($arr[$keys[2]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(GenrePeer::GENRE_ID)) $criteria->add(GenrePeer::GENRE_ID, $this->genre_id);
		if ($this->isColumnModified(GenrePeer::GENRE_NAME)) $criteria->add(GenrePeer::GENRE_NAME, $this->genre_name);
		if ($this->isColumnModified(GenrePeer::GENRE_DESCRIPTION)) $criteria->add(GenrePeer::GENRE_DESCRIPTION, $this->genre_description);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(GenrePeer::GENRE_ID, $this->genre_id);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setGenreName($this->genre_name);

		$copyObj->setGenreDescription($this->genre_description);
