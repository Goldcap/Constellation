...
abstract class BaseMoviePeer {
	...
	/** the column name for the MOVIE_NAME field */
	const MOVIE_NAME = 'movie.MOVIE_NAME';

	/** the column name for the MOVIE_RATE_NO field */
	const MOVIE_RATE_NO = 'movie.MOVIE_RATE_NO';

	/** the column name for the MOVIE_RATE_COUNT field */
	const MOVIE_RATE_COUNT = 'movie.MOVIE_RATE_COUNT';

	/** the column name for the MOVIE_CREATED_AT field */
	const MOVIE_CREATED_AT = 'movie.MOVIE_CREATED_AT';

	/** the column name for the MOVIE_UPDATED_AT field */
	const MOVIE_UPDATED_AT = 'movie.MOVIE_UPDATED_AT';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('MovieId', 'MovieName', 'MovieRateNo', 'MovieRateCount', 'MovieCreatedAt', 'MovieUpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('movieId', 'movieName', 'movieRateNo', 'movieRateCount', 'movieCreatedAt', 'movieUpdatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::MOVIE_ID, self::MOVIE_NAME, self::MOVIE_RATE_NO, self::MOVIE_RATE_COUNT, self::MOVIE_CREATED_AT, self::MOVIE_UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('movie_id', 'movie_name', 'movie_rate_no', 'movie_rate_count', 'movie_created_at', 'movie_updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('MovieId' => 0, 'MovieName' => 1, 'MovieRateNo' => 2, 'MovieRateCount' => 3, 'MovieCreatedAt' => 4, 'MovieUpdatedAt' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('movieId' => 0, 'movieName' => 1, 'movieRateNo' => 2, 'movieRateCount' => 3, 'movieCreatedAt' => 4, 'movieUpdatedAt' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::MOVIE_ID => 0, self::MOVIE_NAME => 1, self::MOVIE_RATE_NO => 2, self::MOVIE_RATE_COUNT => 3, self::MOVIE_CREATED_AT => 4, self::MOVIE_UPDATED_AT => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('movie_id' => 0, 'movie_name' => 1, 'movie_rate_no' => 2, 'movie_rate_count' => 3, 'movie_created_at' => 4, 'movie_updated_at' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	{
		$criteria->addSelectColumn(MoviePeer::MOVIE_ID);
		$criteria->addSelectColumn(MoviePeer::MOVIE_NAME);
		$criteria->addSelectColumn(MoviePeer::MOVIE_RATE_NO);
		$criteria->addSelectColumn(MoviePeer::MOVIE_RATE_COUNT);
		$criteria->addSelectColumn(MoviePeer::MOVIE_CREATED_AT);
		$criteria->addSelectColumn(MoviePeer::MOVIE_UPDATED_AT);
	}
    ...
    foreach (sfMixer::getCallables('BaseMoviePeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseMoviePeer', $values, $con))
      {
		...
		if ($criteria->containsKey(MoviePeer::MOVIE_ID) && $criteria->keyContainsValue(MoviePeer::MOVIE_ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.MoviePeer::MOVIE_ID.')');
		}
    ...
    foreach (sfMixer::getCallables('BaseMoviePeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseMoviePeer', $values, $con))
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(MoviePeer::MOVIE_ID);
			$selectCriteria->add(MoviePeer::MOVIE_ID, $criteria->remove(MoviePeer::MOVIE_ID), $comparison);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(MoviePeer::MOVIE_ID, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(MoviePeer::MOVIE_ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(MoviePeer::DATABASE_NAME);
			$criteria->add(MoviePeer::MOVIE_ID, $pks, Criteria::IN);
