...
abstract class BaseAccountPeer {
	...
	const FK_USER_ID = 'account.FK_USER_ID';

	/** the column name for the ACCOUNT_ACTIVE field */
	const ACCOUNT_ACTIVE = 'account.ACCOUNT_ACTIVE';

	/** the column name for the ACCOUNT_PW_RAW field */
	const ACCOUNT_PW_RAW = 'account.ACCOUNT_PW_RAW';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('AccountId', 'Username', 'Pass', 'FkUserId', 'AccountActive', 'AccountPwRaw', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('accountId', 'username', 'pass', 'fkUserId', 'accountActive', 'accountPwRaw', ),
		BasePeer::TYPE_COLNAME => array (self::ACCOUNT_ID, self::USERNAME, self::PASS, self::FK_USER_ID, self::ACCOUNT_ACTIVE, self::ACCOUNT_PW_RAW, ),
		BasePeer::TYPE_FIELDNAME => array ('account_id', 'username', 'pass', 'fk_user_id', 'account_active', 'account_pw_raw', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('AccountId' => 0, 'Username' => 1, 'Pass' => 2, 'FkUserId' => 3, 'AccountActive' => 4, 'AccountPwRaw' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('accountId' => 0, 'username' => 1, 'pass' => 2, 'fkUserId' => 3, 'accountActive' => 4, 'accountPwRaw' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ACCOUNT_ID => 0, self::USERNAME => 1, self::PASS => 2, self::FK_USER_ID => 3, self::ACCOUNT_ACTIVE => 4, self::ACCOUNT_PW_RAW => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('account_id' => 0, 'username' => 1, 'pass' => 2, 'fk_user_id' => 3, 'account_active' => 4, 'account_pw_raw' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(AccountPeer::USERNAME);
		$criteria->addSelectColumn(AccountPeer::PASS);
		$criteria->addSelectColumn(AccountPeer::FK_USER_ID);
		$criteria->addSelectColumn(AccountPeer::ACCOUNT_ACTIVE);
		$criteria->addSelectColumn(AccountPeer::ACCOUNT_PW_RAW);
	}
