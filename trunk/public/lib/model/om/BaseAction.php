...
abstract class BaseAction extends BaseObject  implements Persistent {
	...
	public function setActionId($v)
	{
		...
		if ($this->action_id !== $v) {
			$this->action_id = $v;
			$this->modifiedColumns[] = ActionPeer::ACTION_ID;
		}
	...
	public function setActionName($v)
	{
		...
		if ($this->action_name !== $v) {
			$this->action_name = $v;
			$this->modifiedColumns[] = ActionPeer::ACTION_NAME;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->action_name = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->resetModified();
			...
			return $startcol + 2; // 2 = ActionPeer::NUM_COLUMNS - ActionPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setActionName($arr[$keys[1]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ActionPeer::ACTION_ID)) $criteria->add(ActionPeer::ACTION_ID, $this->action_id);
		if ($this->isColumnModified(ActionPeer::ACTION_NAME)) $criteria->add(ActionPeer::ACTION_NAME, $this->action_name);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ActionPeer::ACTION_ID, $this->action_id);
	...
	/**
	 * Generic method to set the primary key (action_id column).
	 *
