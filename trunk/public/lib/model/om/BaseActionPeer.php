...
abstract class BaseActionPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Action';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('ActionId', 'ActionName', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('actionId', 'actionName', ),
		BasePeer::TYPE_COLNAME => array (self::ACTION_ID, self::ACTION_NAME, ),
		BasePeer::TYPE_FIELDNAME => array ('action_id', 'action_name', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('ActionId' => 0, 'ActionName' => 1, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('actionId' => 0, 'actionName' => 1, ),
		BasePeer::TYPE_COLNAME => array (self::ACTION_ID => 0, self::ACTION_NAME => 1, ),
		BasePeer::TYPE_FIELDNAME => array ('action_id' => 0, 'action_name' => 1, ),
		BasePeer::TYPE_NUM => array (0, 1, )
	);
	...
	{
		$criteria->addSelectColumn(ActionPeer::ACTION_ID);
		$criteria->addSelectColumn(ActionPeer::ACTION_NAME);
	}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseActionPeer', $criteria, $con);
		}
	 ...
	 */
	public static function addInstanceToPool(Action $obj, $key = null)
	{
		if (Propel::isInstancePoolingEnabled()) {
			if ($key === null) {
				$key = (string) $obj->getActionId();
			} // if key === null
	...
	{
		return $withPrefix ? ActionPeer::CLASS_DEFAULT : ActionPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Action or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseActionPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseActionPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseActionPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseActionPeer', $values, $con, $pk);
    }
	...
	/**
	 * Method perform an UPDATE on the database, given a Action or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseActionPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseActionPeer', $values, $con))
      {
        return $sf_hook_retval;
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(ActionPeer::ACTION_ID);
			$selectCriteria->add(ActionPeer::ACTION_ID, $criteria->remove(ActionPeer::ACTION_ID), $comparison);
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseActionPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseActionPeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the action table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(ActionPeer::TABLE_NAME, $con);
	...
	/**
	 * Method perform a DELETE on the database, given a Action or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(ActionPeer::ACTION_ID, (array) $values, Criteria::IN);
	 ...
	 */
	public static function doValidate(Action $obj, $cols = null)
	{
		$columns = array();
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(ActionPeer::ACTION_ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(ActionPeer::DATABASE_NAME);
			$criteria->add(ActionPeer::ACTION_ID, $pks, Criteria::IN);
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseActionPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
