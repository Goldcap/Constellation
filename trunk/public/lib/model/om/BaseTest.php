...
abstract class BaseTest extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the test_body field.
	 * @var        string
	 */
	protected $test_body;
	...
	/**
	 * Get the [test_body] column value.
	 * 
	 * @return     string
	 */
	...
	public function setTestId($v)
	{
		...
		if ($this->test_id !== $v) {
			$this->test_id = $v;
			$this->modifiedColumns[] = TestPeer::TEST_ID;
		}
	...
	/**
	 * Set the value of [test_body] column.
	 * 
	 * @param      string $v new value
	 * @return     Test The current object (for fluent API support)
	 */
	public function setTestBody($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->test_body !== $v) {
			$this->test_body = $v;
			$this->modifiedColumns[] = TestPeer::TEST_BODY;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->test_body = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->resetModified();
			...
			return $startcol + 2; // 2 = TestPeer::NUM_COLUMNS - TestPeer::NUM_LAZY_LOAD_COLUMNS).
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$this->setTestId($pk);  //[IMV] update autoincrement primary key
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setTestBody($arr[$keys[1]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TestPeer::TEST_ID)) $criteria->add(TestPeer::TEST_ID, $this->test_id);
		if ($this->isColumnModified(TestPeer::TEST_BODY)) $criteria->add(TestPeer::TEST_BODY, $this->test_body);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(TestPeer::TEST_ID, $this->test_id);
	...
	/**
	 * Generic method to set the primary key (test_id column).
	 *
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setTestBody($this->test_body);


		$copyObj->setNew(true);

		$copyObj->setTestId(NULL); // this is a auto-increment column, so set to default value
