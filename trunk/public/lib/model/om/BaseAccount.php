...
abstract class BaseAccount extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the account_active field.
	 * @var        int
	 */
	protected $account_active;

	/**
	 * The value for the account_pw_raw field.
	 * @var        string
	 */
	protected $account_pw_raw;
	...
	/**
	 * Get the [account_active] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Get the [account_pw_raw] column value.
	 * 
	 * @return     string
	 */
	public function getAccountPwRaw()
	{
		return $this->account_pw_raw;
	}
	...
	public function setUsername($v)
	{
		...
		if ($this->username !== $v) {
			$this->username = $v;
			$this->modifiedColumns[] = AccountPeer::USERNAME;
		}
	...
	public function setPass($v)
	{
		...
		if ($this->pass !== $v) {
			$this->pass = $v;
			$this->modifiedColumns[] = AccountPeer::PASS;
		}
	...
	public function setFkUserId($v)
	{
		...
		if ($this->fk_user_id !== $v) {
			$this->fk_user_id = $v;
			$this->modifiedColumns[] = AccountPeer::FK_USER_ID;
		}
	...
	/**
	 * Set the value of [account_active] column.
	 * 
	 * @param      int $v new value
	 * @return     Account The current object (for fluent API support)
	 */
	public function setAccountActive($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->account_active !== $v) {
			$this->account_active = $v;
			$this->modifiedColumns[] = AccountPeer::ACCOUNT_ACTIVE;
		}
	...
	/**
	 * Set the value of [account_pw_raw] column.
	 * 
	 * @param      string $v new value
	 * @return     Account The current object (for fluent API support)
	 */
	public function setAccountPwRaw($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->account_pw_raw !== $v) {
			$this->account_pw_raw = $v;
			$this->modifiedColumns[] = AccountPeer::ACCOUNT_PW_RAW;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->account_active = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->account_pw_raw = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->resetModified();
			...
			return $startcol + 6; // 6 = AccountPeer::NUM_COLUMNS - AccountPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 3:
				...
				break;
			case 4:
				return $this->getAccountActive();
				break;
			case 5:
				return $this->getAccountPwRaw();
				break;
			default:
				return null;
				break;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[4] => $this->getAccountActive(),
			$keys[5] => $this->getAccountPwRaw(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setAccountActive($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setAccountPwRaw($arr[$keys[5]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AccountPeer::USERNAME)) $criteria->add(AccountPeer::USERNAME, $this->username);
		if ($this->isColumnModified(AccountPeer::PASS)) $criteria->add(AccountPeer::PASS, $this->pass);
		if ($this->isColumnModified(AccountPeer::FK_USER_ID)) $criteria->add(AccountPeer::FK_USER_ID, $this->fk_user_id);
		if ($this->isColumnModified(AccountPeer::ACCOUNT_ACTIVE)) $criteria->add(AccountPeer::ACCOUNT_ACTIVE, $this->account_active);
		if ($this->isColumnModified(AccountPeer::ACCOUNT_PW_RAW)) $criteria->add(AccountPeer::ACCOUNT_PW_RAW, $this->account_pw_raw);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setAccountActive($this->account_active);

		$copyObj->setAccountPwRaw($this->account_pw_raw);
