...
class lime_test
{
  ...
  public function __construct($plan = null, $options = array())
  {
    ...
    $this->testname = $this ->options['testname'] ? $this ->options['testname'] : "the test(s)";
  ...
  public function __destruct()
  {
    ...
    {
      $this->output->green_bar(sprintf("# Looks like everything went fine with %s.", $this -> testname));
    }
