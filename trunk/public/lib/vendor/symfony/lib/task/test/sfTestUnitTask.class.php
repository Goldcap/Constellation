...
class sfTestUnitTask extends sfTestBaseTask
{
  ...
  protected function configure()
  {
    ...
    $this->addOptions(array(
      ...
      new sfCommandOption('widget', null, sfCommandOption::PARAMETER_REQUIRED, 'The widget name for PageWidget Testing'),
      new sfCommandOption('app', null, sfCommandOption::PARAMETER_REQUIRED, 'The app to test')
    ));
