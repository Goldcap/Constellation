...
class seleniumTask extends sfBaseTask
{
...
EOF;
  ...
  protected function runTest($arguments = array(), $options = array()) 
  {
    ...
    //DEFINE the App, and Env, vars
    DEFINE(SF_APP,$options['application']);
    DEFINE(SF_ENV,$options['env']);
    ...
    $test = new Selenium_PageWidget( $context, $arguments );
