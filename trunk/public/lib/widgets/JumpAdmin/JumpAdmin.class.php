<?php
  ...
  //require_once 'crud/JumpAdmin_crud.php';
  
   class JumpAdmin_PageWidget extends Widget_PageWidget {
  ...
  var $XMLForm;
    ...
    $this -> crud = new JumpCrud( $context );
    ...
    $form = $this -> drawPage();
    $sql = "select count(*) from jump";
    $res = $this -> propelQuery($sql);
    
    $this -> widget_vars["count"] = $res -> fetchall();
