<?php
  ...
  //require_once 'crud/Film_crud.php';
   ...
   class FilmView_PageWidget extends Widget_PageWidget {
  ...
  var $XMLForm;
   ...
   $screens = $this ->dataMap(sfConfig::get('sf_lib_dir')."/widgets/FilmView/query/Screening_list_datamap.xml");
   ...
   if ($list["data"][0]["film_use_sponsor_codes"] == 1) {
    $this -> addJs("/js/sponsor.js");
   } else {
    $this -> addJs("/js/purchase.js"); 
   }
   ...
   $this -> setMeta( "og:description", strip_tags($list["data"][0]["film_info"]) );
