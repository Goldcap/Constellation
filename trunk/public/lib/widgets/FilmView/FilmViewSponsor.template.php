<?php if ($film["film_background_image"] != '') {?>
...
<?php if ($film["film_use_sponsor_codes"] == 0) {
if (($sf_user -> isAuthenticated()) && (($film["film_allow_user_hosting"]== 1) || ($film["film_allow_hostbyrequest"]))) {?>
...
<div class="pop_up" id="process" style="display: none">
  ...
  <div class="pop_top popup-close"></div> 
  	<div class="layout-1 clearfix">
      	<br />
        <div class="title"><strong><span id="purchase_result">Your purchase is being processed.</span></strong></div>
        <br />
