<?php
  ...
  //require_once 'crud/Conversation_crud.php';
  
  class Conversation_PageWidget extends Widget_PageWidget {
  ...
  var $XMLForm;
    ...
    // $this -> crud = new ConversationCrud( $context );
   ...
   //dump($this -> widget_vars["film"]["film_id"]);
