<?php
  ...
  //require_once 'crud/FeaturedSearch_crud.php';
  
   class FeaturedSearch_PageWidget extends Widget_PageWidget {
  ...
  var $XMLForm;
	...
	function parse() {
	   ...
	   //$this -> showData();
    $films = $this ->dataMap(sfConfig::get('sf_lib_dir')."/widgets/Body/query/FilmHome_list_datamap.xml");
