            ...
            <tr>
              <td style="border-collapse: collapse;">
                ...
                <div class="ctv_theater" style="margin: 10px 0;padding: 20px 0;border-bottom: solid 1px #c0c0c0;border-top: solid 1px #c0c0c0;text-align: center;">
                  <a href="http://<?php echo  sfConfig::get("app_domain");?>/theater/<?php echo $screening['screening_unique_key'] ;?>" style="color: #2d98dc;font-size: 30px;line-height: 30px;font-weight: 200;text-decoration: none;">ENTER THE THEATER &raquo;</a>
                </div>
                <p style="color: #666;margin: 1em 0;">
