						...
						<tr>
							<td style="border-collapse: collapse;">
								<div class="ctv_block" style="padding: 20px;font-size: 14px;">
									...
									<p style="margin: 1em 0;"><?php echo $name;?> has invited you check out <?php echo $film['screening_film_name'];?><?php echo !empty($film['screening_film_makers']) ? ", directed by " .$film['screening_film_makers'] : '';?> on Constellation. </p>
									<?php if(!empty($message)):?>
									<p><?php echo $name;?> said:</p>
									<blockquote><p><?php echo $message;?></p></blockquote>
									<?php endif;?>
									<p style="margin: 1em 0;"><a href="http://www.constellation.tv/theater/<?php echo $film["screening_unique_key"];?>?rf=<?php echo $beacon;?>" style="color: #2d98dc;">Click here</a> to enter the theater.</p>
								...
								<img src="http://constellation.tv/uploads/screeningResources/<?php echo $film["screening_film_id"];?>/logo/purchase_email_poster<?php echo $film["screening_film_logo"];?>" align="left" style="margin: 40px 20px;outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;display: block;">
							</td>							
						</tr>
					</table>
				</td>
