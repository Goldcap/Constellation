<div style="width:676px;height:263px;font-family:'Helvetica Neue',Helvetica,Arial,Verdana,sans-serif;color:#fff;background-image:url('http://<?php echo sfConfig::get("app_domain");?>/images/ticketbg_walmart.png');background-repeat:no-repeat;background-position:left top;background-color:#040027;">
	<div style="width:661px;padding:0 0 0 15px;overflow:hidden;">
		...
		<div style="float:left;width:200px;height:214px;overflow:hidden;padding:16px 0 33px 17px;">
			...
			<p style="margin-top: 90px"><a href="http://truthbetold.constellation.tv/film/20" style="margin-bottom:1px;font-size:16px;line-height:21px;color:#f79c33;font-weight:bold;text-decoration:none;">ENTER THE THEATER</a></p>	
		</div>
...
<table>
  <tr>
    <td>
      <strong>Welcome to Family Movie Night, with Candace Cameron Bure presenting TRUTH BE TOLD on Monday April 4 and Tuesday April 5, at 8pm EST. </strong> 
    </td>
  </tr>  
  <tr>
    <td>
  ...
  <tr>
    <td>
      <ol>
        <li>Click "Enter the Theater" on the ticket above.</li>
  ...
  <tr>
    <td>
      <i>Note that your ticket will only be valid beginning on April 4 at 7pm EST.</i>
    </td>
  </tr>
  <tr>
    <td>
