						...
						<tr>
							<td style="border-collapse: collapse;">
								<div class="ctv_block" style="padding: 20px;font-size: 14px;">
									<p class="ctv_p_m" style="margin: 1em 0;font-size: 18px;">Dear <?php echo $user->getUserUsername();?>,</p>

									<p style="margin: 1em 0;">Thanks for watching <?php echo $screening['screening_film_name'];?> on <?php echo date("l, F jS, Y",strtotime($screening['screening_date'])) ;?>. </p>
									<p style="margin: 1em 0;">What did you think of the movie? Add your voice to the conversation.</p>
									<p style="margin: 1em 0;"><a href="http://www.constellation.tv/film/<?php echo $screening['screening_film_id'];?>" style="color: #2d98dc;"><img src="http://s3.amazonaws.com/cdn.constellation.tv/prod/images/email/add-voice.png" alt="add your voice" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;display: block;border: none;"></a>
									</p>
									<p style="margin: 1em 0;">We are constantly trying to improve the experience for filmmakers and their audiences. <a href="http://getsatisfaction.com/constellation" style="color: #2d98dc;">Tell Us</a> what you think of Constellation.</p>
