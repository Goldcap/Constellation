						...
						<tr>
							<td style="border-collapse: collapse;">
								<div class="ctv_block" style="padding: 20px;font-size: 14px;">
									...
									<p style="margin: 1em 0;">Your password is: <?php echo $pass;?></p>
									<p style="margin: 1em 0;">Change your password at any time by going to your <a href="http://www.constellation.com/account" style="color: #2d98dc;"> account page</a>.</p>
