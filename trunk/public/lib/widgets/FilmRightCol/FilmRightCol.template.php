...
<span><a href="#" id="host_screening_button"><button id="hostascreening" class="btn_med-og">Host A Screening</button></a></span>
<?php } ?>
...
<?php if ($vars["FilmView"]["column1"][0]["film"]["film_allow_hostbyrequest"] == 1) {?>
<div style="padding-top: 10px"><span><a href="#" id="hbr_request_button"><button class="btn_tiny_og">Watch Now</button></a></span></div>
<?php }?>
