...
.form-row .input input[type="checkbox"] + label {
    color: #666;
    display: block;
    float: none;
    font-size: 12px;
...
<!-- 
		...
		<form id="login_form" name="login_form" action="/services/Signup" method="POST" class="login_form clearfix">
			<div class="form-fieldset-full">
			<div class="form-row clearfix">
				<label for="email">Username</label>
				<div class="input">
					<input class="text-input span6 large" id="username" name="username" value="<?php echo $post["username"];?>" />
				</div>
			</div>
			<div class="form-fieldset-full">
			<div class="form-row clearfix">
			...
			<div class="form-row clearfix">
				...
				<div class="input">
					<input class="text-input span6 large" id="password" name="password" value="<?php echo $post["password"];?>" />
				</div>
			</div>
			<div class="form-row clearfix">
				<label for="password">Confirm Password</label>
				<div class="input">
					<input class="text-input span6 large" id="password" name="password2" value="<?php echo $post["password2"];?>" />
				</div>
			</div>

			<div class="form-row clearfix">
                <div class="input">
                	<input type="checkbox" checked="checked" class="" name="optin" id="optin">
                  	<label for="optin">I agree to receive Constellation's weekly newsletter.</label>
                </div>
	    	</div>

			<div class="form-row clearfix">
 				<button class="button button_orange uppercase right">Signup</button>
	 		</div>
			</div>
<!-- 
