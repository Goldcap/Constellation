...
var screening_room = {
  ...
  init: function() {
    ...
    if (window.location.pathname.match(/^\/theater/)) {
			$("#screening_click_link .btn_small").html("Watch the Film");
		}
  ...
  confirm : function() {
    ...
    screening_room.purchaseSubmitted = false;
    $("#screening_purchase").fadeOut("slow").queue(function() {
      $("#confirm").fadeIn("slow");
      $("#screening_purchase").clearQueue();
    });
  },
  ...
  hostbyrequest: function() {
    ...
    //console.log("Setting Screening Time and User");
    $("#dohbr").val("true");
    $(".current_screening_time").html("Now");
    $(".current_screening_host").html("You");
