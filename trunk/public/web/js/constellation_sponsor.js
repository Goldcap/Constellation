...
(function ($) {
        ...
        if (settings.totalItem == 1) {
            ...
            if (settings.navType == 1) {
                ...
                settings.navList.each(function (n) { this.index = n; });
						...
						$("#barousel_broadcast").click(function(e){
								console.log("Broadcast says should be loading item " + $(".thslide_list ul .current").attr("id"));
						});
            ...
            if (settings.navType == 1 || settings.navType == 3) {
                ...
                settings.navList.each(function (n) {
                    $(this).click(function () {
                      console.log("Type 1 or 3, Clicked "+n);
    ...
    var loadItem = function (settings, index) {
        ...
        console.log("Should be loading item " + $(".thslide_list ul .current").attr("id"));
