<div class="alternate_container">
  ...
  <div id="today_screenings" class="alternate">
    ...
    <div>
      <?php if ($sponsor) {?>
      <a class="purchase_link" title="<?php echo $screening["screening_unique_key"];?>" href="/film/<?php echo $film["program_short_name"];?>/detail/<?php echo $screening["screening_unique_key"];?>" id="get ticket now"><button class="btn_sponsor">GET TICKET NOW</button></a>
      <? } else { ?>
      <a class="screening_link" title="<?php echo $screening["screening_unique_key"];?>" href="/film/<?php echo $film["program_short_name"];?>/detail/<?php echo $screening["screening_unique_key"];?>" id="get ticket now"><button class="btn_sponsor">PURCHASE TICKET</button></a>
      <? } ?>
    </div>
    ...
    <p>
    Invite Friends. Buy Ticket. Watch Together.
    </p>
  </div>
</div>
