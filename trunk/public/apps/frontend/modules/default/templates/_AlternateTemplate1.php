  ...
  <div id="today_screenings" class="alternate">
    ...
    <?php } else {?>
      <p>Followed by a live Q+A with the director.</p>
			<!-- <?php echo $screening["screening_description"];?> -->
    <?php }?>
    ...
    <div>
      <?php if ($sponsor) {?>
      <a class="purchase_link" title="<?php echo $screening["screening_unique_key"];?>" href="/film/<?php echo $film["film_id"];?>/detail/<?php echo $screening["screening_unique_key"];?>" id="get ticket now" onclick="screening_room.pay()"><button class="btn_sponsor">GET TICKET NOW</button></a>
      <? } else { ?>
      <a class="screening_link" title="<?php echo $screening["screening_unique_key"];?>" href="/film/<?php echo $film["film_id"];?>/detail/<?php echo $screening["screening_unique_key"];?>" id="get ticket now" onclick="screening_room.pay()"><button class="btn_sponsor">GET TICKET NOW</button></a>
      <? } ?>
    </div>
