...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en"><head>
  ...
  <?php } else { ?>
	  ...
	  <script type="text/javascript" src="/js/CTV.Dialog.js?v=<?php echo $version;?>"></script>
		...
		<script type="text/javascript" src="/js/constellation_alt_comp_v30.js"></script> 
	  ...
	  <script type="text/javascript" src="/js/trailer_alt.js"></script>
	  <script type="text/javascript" src="/js/countdown_alt.js"></script>
	  <script type="text/javascript" src="/js/error_alt.js"></script>
	  <script type="text/javascript" src="/js/allfilms.js"></script>
	  <script type="text/javascript" src="/js/screening_attendees.js"></script>
	  <script type="text/javascript" src="/js/jquery/slides.min.jquery.js"></script>
	  <script type="text/javascript" src="/js/slideshow.js"></script>
	  <script type="text/javascript" src="/js/header.js"></script>
	  <script type="text/javascript" src="/js/jquery/jquery-asyncUpload-0.1.js"></script>
